        ...
        <div className="box">
          ...
          <div className="list">
            ...
            <div className="pbox">
              ...
              数据：
              <ul>
                {this.state.mokeAjax.map((item: any, index: number) => (
            ...
            <div className="pbox">
              ...
              数据：
              <ul>
                {this.state.mokeFetch.map((item: any, index: number) => (
                  <li key={index}>{`id: ${item.id}, email: ${item.email}`}</li>
                ))}
              </ul>
            </div>
...
const FormConmponents = Form.create({ name: 'form_name' })(TestPageContainer);
